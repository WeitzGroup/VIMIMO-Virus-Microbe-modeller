...
% beta
pars2.beta2 = [0  158.7231         0         0         0;
 550.7512  105.9496  70.1492         0         0;
         0         0   10.7017         0         0;
         0         0         0  522.0549  45.2599;
         0         0         0  585.1209  45.9918];
...
model = SEIVD_diff_NE_diff_debris_abs_diffbeta(5,5,max_NE);
model.host_growth = 0;
model.viral_decay = 0;
