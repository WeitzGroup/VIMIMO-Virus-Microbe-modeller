...
pars2.NE = 100*pars2.M; %otherwise this will take a very long time
...
[t_after,S_after,V_after,D_after,I_after,E_after] =  simulate_ode(model,pars2,tvec,pars2.S0,pars2.V0); % mcmc parameter set
