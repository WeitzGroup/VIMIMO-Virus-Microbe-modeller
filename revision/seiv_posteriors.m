...
seed = 20031;
load('./../results/seed196L0_datasheet.mat');
chain_stored = chain;
...
load('./../results/SEIV-beta-30013.mat','chain')
chain_stored(:,6:14) =chain(5001:10000,:);


load('./../results/SEIV-beta-30014.mat','chain')
chain_stored2(:,6:14) = chain(5001:10000,:);


load('./../results/SEIV-beta-30015.mat','chain')
chain_stored3(:,6:14) = chain(5001:10000,:);


load('./../results/SEIV-beta-30014.mat','chain')
chain_stored4(:,6:14) = chain(5001:10000,:);
...
load('./../results/SEIV-tau-30017.mat','chain');
chain_stored(:,34:42) = chain(5001:10000,:);

load('./../results/SEIV-tau-30014.mat','chain');
chain_stored2(:,34:42) = chain(5001:10000,:);

load('./../results/SEIV-tau-30015.mat','chain');
chain_stored3(:,34:42) = chain(5001:10000,:);


load('./../results/SEIV-tau-30016.mat','chain');
chain_stored4(:,34:42) = chain(5001:10000,:);


%% add the phi part
load('./../results/SEIV-phi-30013.mat','chain');
chain_stored(:,15:23) = chain(5001:10000,:);

load('./../results/SEIV-phi-30014.mat','chain');
chain_stored2(:,15:23) = chain(5001:10000,:);


load('./../results/SEIV-phi-30013.mat','chain');
chain_stored3(:,15:23) = chain(5001:10000,:);


load('./../results/SEIV-phi-30014.mat','chain');
chain_stored4(:,15:23) = chain(5001:10000,:);


%% add the r part
load('./../results/SEIV-r-30013.mat','chain');
chain_stored(:,1:5) = chain(5001:10000,:);

load('./../results/SEIV-r-30014.mat','chain');
chain_stored2(:,1:5) = chain(5001:10000,:);


load('./../results/SEIV-r-30015.mat','chain');
chain_stored3(:,1:5) = chain(5001:10000,:);


load('./../results/SEIV-r-30014.mat','chain');
chain_stored4(:,1:5) = chain(5001:10000,:);
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored(:,i+5),Color=blue);hold on;
xlim([0 5000]);
if i == 9
...
subplot(9,2,2*i)
histogram(chain_stored(:,i+5),'DisplayStyle','stairs','NumBins',25,'Normalization','pdf','LineWidth',1,'EdgeColor',blue); hold on;
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored(:,i+33),Color=blue); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored(:,i+33),'DisplayStyle','stairs','NumBins',100,'Normalization','pdf','LineWidth',1,'EdgeColor',blue);
hold on;
plot(-1:27,gaussian(-1:27,priors.tau.mean(i),priors.tau.std(i)),'LineWidth',2,'Color','k')
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored(:,i+14),Color=blue); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored(:,i+14),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',blue);
hold on;
...
subplot(5,2,2*i)
histogram(chain_stored(:,i),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',blue);
hold on;
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored2(:,i+5),Color=yellow); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored2(:,i+5),'DisplayStyle','stairs','NumBins',25,'Normalization','pdf','LineWidth',1,'EdgeColor',yellow); hold on;
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored2(:,i+33),Color=yellow); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored2(:,i+33),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',yellow);
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored2(:,i+14),Color=yellow); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored2(:,i+14),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',yellow);
hold on;
set(gca, 'YScale', 'log');
xlim([-15 -5]);
...
subplot(5,2,2*i)
histogram(chain_stored2(:,i),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',yellow);
hold on;
xlim([0 0.8]);
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored3(:,i+5),Color=purple); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored3(:,i+5),'DisplayStyle','stairs','NumBins',25,'Normalization','pdf','LineWidth',1,'EdgeColor',purple); hold on;
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored3(:,i+33),Color=purple); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored3(:,i+33),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',purple);
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored3(:,i+14),Color=purple); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored3(:,i+14),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',purple);
hold on;
set(gca, 'YScale', 'log');
xlim([-10 -7]);
...
for i = 1:5
subplot(5,2,2*i-1)
plot(chain_stored3(:,i),Color=purple); hold on;
xlim([0 5000]);

subplot(5,2,2*i)
histogram(chain_stored3(:,i),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',purple);
hold on;
xlim([0 0.8]);
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored4(:,i+5),Color=green); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored4(:,i+5),'DisplayStyle','stairs','NumBins',25,'Normalization','pdf','LineWidth',1,'EdgeColor',green); hold on;
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored4(:,i+33),Color=green); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored4(:,i+33),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',green);
...
for i = 1:9
subplot(9,2,2*i-1)
plot(chain_stored4(:,i+14),Color=green); hold on;
xlim([0 5000]);

subplot(9,2,2*i)
histogram(chain_stored4(:,i+14),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',green);
hold on;
set(gca, 'YScale', 'log');
xlim([-12 -6]);
...
for i = 1:5
subplot(5,2,2*i-1)
plot(chain_stored4(:,i),Color=green); hold on;
xlim([0 5000]);

subplot(5,2,2*i)
histogram(chain_stored4(:,i),'DisplayStyle','stairs','NumBins',50,'Normalization','pdf','LineWidth',1,'EdgeColor',green);
hold on;
xlim([0 0.8]);
...
pars2 = update_pars(pars2,pars_from_dist(chain_stored(1:end,:)),mcmcpars);
tvec = 0:0.05:15.75; % for better viz
[t2,S2,V2,D2] = simulate_ode(model,pars2,tvec,pars2.S0,pars2.V0); % mcmc parameter set


[S_min,S_max,V_min,V_max,S_median,V_median] = find_confidence_interval_looped(chain_stored4,1,mcmcpars,0.95,model, pars2);
