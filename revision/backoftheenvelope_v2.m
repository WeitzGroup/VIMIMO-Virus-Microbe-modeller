...
pars2.beta = [0  388.7231         0         0         0;
  600.7512  395.9496  518.1492         0         0;
         0         0   10.7017         0         0;
         0         0         0  222.0549  123.2599;
         0         0         0  385.1209  100.9918];
...
model.name = 'SEIVD';
[t2,S_median,V_median,D_median] =  simulate_ode(model,pars2,tvec,pars2.S0,pars2.V0); % mcmc parameter set
