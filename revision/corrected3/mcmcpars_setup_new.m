...
tmp_mcmcpars.beta.priorstd = [100 50 100 50 50 200 200 50 50];
%tmp_mcmcpars.beta.priorstd = 1000*ones(1,10);
...
tmp_mcmcpars.tau.priorstd = 2*[0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5];
