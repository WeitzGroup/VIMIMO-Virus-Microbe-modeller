...
startval.beta = [200  1.7 206 100 21 522 485 60 51];
startval.phi = [-7.7447  -7.2218  -7.0969  -7.6021  -7.0458  -7.2218  -7.2218  -7.8911  -7.6576];
startval.tau = [1.7 3 2.7 2.3 2 1.8 2.3 4.7 2];
