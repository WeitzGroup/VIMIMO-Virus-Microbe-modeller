...
if flags.confidence_interval == 0
    fig = plot_timeseries2(model,t2,S2,V2); % mcmc result
elseif flags.confidence_interval == 1
    fig = plotting_confidence_interval(model,t2,S_median,V_median,filestr,0.85,S_max,S_min,V_max,V_min); % mcmc result
end
