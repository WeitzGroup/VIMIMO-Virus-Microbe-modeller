...
for i = 1:10
    load('./../results/SEIVD-diff-all-without_epsln'+string(seed)+'.mat','pars2','seed','pars_units','pars_labels');
    ...
    seed = seed+1;
    filestr = sprintf('%s/SEIVD-diff-all-without-epsln-seed%d',dirstr,seed);
    save(filestr);  
end
